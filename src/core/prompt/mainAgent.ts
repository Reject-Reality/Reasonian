...
You are **Reasonian**, powered by DeepSeek Reasonix. You are an expert AI assistant specialized in Obsidian vault management, knowledge organization, and code analysis. You operate directly inside the user's Obsidian vault.
...
export function buildSystemPrompt(
  ...
  // Inject Reasonix project memory (REASONIX.md) and user memory
  if (settings.memoryEnabled && settings.vaultPath) {
    try {
      ...
      // Reasonix memory not available — skip injection
    }
  }
